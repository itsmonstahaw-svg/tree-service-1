        ...
        <section className="py-16 md:py-24 bg-white text-black">
          <div className="w-full max-w-[1200px] mx-auto px-[12px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <img src="/images/work1.jpg" alt="Storm cleanup service image 1" className="w-full h-64 object-cover rounded-lg shadow-md border border-border" />
              <img src="/images/work2.jpg" alt="Storm cleanup service image 2" className="w-full h-64 object-cover rounded-lg shadow-md border border-border" />
              <img src="/images/work3.jpg" alt="Storm cleanup service image 3" className="w-full h-64 object-cover rounded-lg shadow-md border border-border" />
            </div>
          </div>
        </section>
